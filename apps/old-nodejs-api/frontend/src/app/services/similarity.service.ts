...
export class SimilarityService {
   ...
   */
  getSuggestions(filters?: SuggestionsFilters): Observable<SuggestionsResponse> {
    ...
    if (filters?.min_similarity !== undefined) {
      params["min_similarity"] = filters.min_similarity.toString();
    }
    ...
    return this.http.get<SuggestionsResponse>(`${this.getApiUrl()}/similarity/suggestions`, {
      params,
      headers: {
  ...
  applySuggestions(suggestions: FixSuggestion[]): Observable<ApplyResponse> {
    return this.http.post<ApplyResponse>(`${this.getApiUrl()}/similarity/apply`, {
