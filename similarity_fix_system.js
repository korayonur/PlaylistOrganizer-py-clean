...
console.log('🚀 Kelime Eksiltmeli Benzerlik Fix Sistemi Başlatılıyor...\n');

class SimilarityFixSystem {
    constructor() {
        this.db = new Database('./musicfiles.db');
        this.wordSimilarity = new WordSimilaritySearch();
        this.setupTables();
    }

    setupTables() {
        console.log('1️⃣ Fix Önerileri Tablosu Oluşturuluyor...');
        ...
        this.db.exec(`
            CREATE TABLE IF NOT EXISTS similarity_fix_suggestions (
                ...
                fix_type TEXT NOT NULL, -- 'exact', 'high', 'medium', 'low'
    ...
    async processTracks(limit = 100) {
        console.log(`2️⃣ ${limit} Track İşleniyor...`);
        
        // Eşleşmemiş track'ları al
    ...
    calculateSimilarity(trackName, musicFileName) {
        // Kelime eksiltmeli benzerlik hesaplama
...
// Test çalıştır
const fixSystem = new SimilarityFixSystem();
fixSystem.run(20); // İlk 20 track ile test
